...
public class IntegralProductAdapter extends BaseAdapter {
	...
	public IntegralProductAdapter(Context context, ArrayList<ProductModel> productList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = layoutInflater.inflate(R.layout.activity_integral_list_item_layout, null);
			viewHolder = new ViewHolder();
			viewHolder.tv_name = (TextView) convertView
					.findViewById(R.id.tv_name);
			viewHolder.img_show =(ImageView)convertView.findViewById(R.id.img_show);
			viewHolder.tv_integral =(TextView)convertView.findViewById(R.id.tv_integral);
		...
		viewHolder.tv_integral.setText(jifen+"积分");
