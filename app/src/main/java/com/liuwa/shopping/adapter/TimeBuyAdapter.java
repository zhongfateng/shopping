...
public class TimeBuyAdapter extends BaseAdapter {
	...
	public TimeBuyAdapter(Context context, ArrayList<ProductModel> productList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = layoutInflater.inflate(R.layout.activity_time_buy_item_layout, null);
