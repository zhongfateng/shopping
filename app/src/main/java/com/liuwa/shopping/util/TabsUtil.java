...
public abstract class TabsUtil {
	...
	private static View prepareTabView(Context context, String text, int drawable) {
		View view = LayoutInflater.from(context).inflate(R.layout.main_tab_navigator, null);
		...
		if (!TextUtils.isEmpty(text)) {
			...
			LayoutParams mParams = new LayoutParams(ScreenUtil.dip2px(context, 50), ScreenUtil.dip2px(context, 50));
