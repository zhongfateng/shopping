...
import com.liuwa.shopping.adapter.AddressListAdapter;
import com.liuwa.shopping.util.DataConversionUtils;
import com.liuwa.shopping.util.DatasKey;
import com.liuwa.shopping.util.OnItemClickLisenter;
import com.liuwa.shopping.util.SPUtils;

import java.util.ArrayList;
import java.util.List;

public class NeiborActivity extends Activity {
    ...
    public static final int SEARCHREQUESTCODE = 1001;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_map_neibor);
        initView();
...
//                    doSearchQuery(true, "", location.getCity(), new LatLonPoint(cameraPosition.target.latitude, cameraPosition.target.longitude));
            ...
            public void onRegeocodeSearched(RegeocodeResult regeocodeResult, int i) {
                if (i == 1000) {
                    if (regeocodeResult != null) {
                        ...
                        mAddressListAdapter.setList(mList);
                ...
                try {
                    if (null != loc) {
                        ...
                        if (loc.getErrorCode() == 0) {//可在其中解析amapLocation获取相应内容。
                            location = loc;
                            SPUtils.putString(NeiborActivity.this, DatasKey.LOCATION_INFO, gson.toJson(location));
        ...
        //recycleview列表监听器
        mAddressListAdapter.setOnItemClickLisenter(new OnItemClickLisenter() {
            @Override
            ...
            public void onClick(View view) {
                switch (view.getId()) {
                    case R.id.iv_back:
                        ...
                        break;
                    case R.id.iv_search:
//                        Toast.makeText(NeiborActivity.this, "搜索", Toast.LENGTH_SHORT).show();
                        startActivityForResult(new Intent(NeiborActivity.this, SearchActivity.class), SEARCHREQUESTCODE);
                        break;
                    case R.id.iv_location:
//                        Toast.makeText(NeiborActivity.this, "定位", Toast.LENGTH_SHORT).show();
                        ...
                        break;
                    case R.id.bt_send:
                        if (null != mList && 0 < mList.size() && null != mAddressListAdapter) {
    ...
    private void initDatas(Bundle savedInstanceState) {
        ...
        mList = new ArrayList<>();
        mAddressListAdapter = new AddressListAdapter(this, mList);
