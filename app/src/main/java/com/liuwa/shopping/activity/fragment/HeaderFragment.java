...
import com.liuwa.shopping.adapter.HeaderItemAdapter;
...
public class HeaderFragment extends Fragment{
    ...
    private HeaderItemAdapter headerItemAdapter;
    private ArrayList<HeaderModel> headerModels = new ArrayList<HeaderModel>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        headerItemAdapter =  new HeaderItemAdapter(getActivity(), headerModels);
        ...
        pullToRefreshListView.setAdapter(headerItemAdapter);
